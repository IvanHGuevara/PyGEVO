...
def createPhenotypes():
    prepareExperiment()
    pop = Population("grammar.bnf",numberIndividuals=100, individualSize=8, fitness_function=processIndividual)
    population = pop.generatePop()
    algo = Algorithms("grammar.bnf", initBNF=1, debug=False)
    evolvedPop = algo.evolveWithGE(population, populationFactory=pop, gen=4, porcentSelect=0.2, staticSelection=50)
